    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "PUBLICACIÓN", Snackbar.LENGTH_LONG)
                        .setAction("Crear", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                startActivity(new Intent(MainActivity.this, NewPublication.class));
                            }
                        }).show();
            }
        });
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    ...
                    return fp;
                default:
                    Fragment_Event fge = new Fragment_Event();
                    return fge;
            }
        }
